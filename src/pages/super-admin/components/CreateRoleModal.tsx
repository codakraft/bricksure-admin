...
interface CreateRoleModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (role: Omit<Role, 'id' | 'createdAt' | 'createdBy'>) => void;
  availableRights: Right[];
}

export function CreateRoleModal({ isOpen, onClose, onSubmit, availableRights }: CreateRoleModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onClose();
    setFormData({ name: '', description: '', rights: [] });
  };
