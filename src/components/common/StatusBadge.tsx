...
const statusConfig: Record<Status, { label: string; color: string }> = {
  ...
  underwriting: { label: 'Underwriting', color: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
  ...
  'under-review': { label: 'Under Review', color: 'bg-purple-100 text-purple-800 border-purple-200' },
  rejected: { label: 'Rejected', color: 'bg-red-100 text-red-800 border-red-200' },
  amended: { label: 'Amended', color: 'bg-indigo-100 text-indigo-800 border-indigo-200' },
  ...
  investigating: { label: 'Investigating', color: 'bg-purple-100 text-purple-800 border-purple-200' }
};
